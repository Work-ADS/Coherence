    ...
    >
      ...
      <div slot="code-tab">
        ...
        <afi-component-playground [code]="codeSnippet()">
          <div slot="controls" class="space-y-space-4">
            <!-- Intent -->
            <afi-radio-group legend="Intención">
              @for (i of intents; track i) {
                <afi-radio-group-item
                  [value]="i"
                  [label]="i"
                  [selected]="intent() === i"
                  (selectedChange)="$any(intent).set($event)"
                  size="sm"
                  [compact]="true"
                />
              }
            ...
            <fieldset>
              ...
              <afi-checkbox
                [checked]="dot()"
                (checkedChange)="dot.set($event)"
                label="dot (solo indicador)"
                size="sm"
                [compact]="true"
              />
            </fieldset>
            ...
            <div>
              ...
              <afi-input
                size="sm"
                [value]="content()"
                (valueChange)="content.set($event?.toString() ?? '')"
              />
            </div>
          </div>
          ...
          <div slot="preview" class="flex items-center gap-space-4">
            <afi-badge [intent]="intent()" [size]="size()" [dot]="dot()">{{ content() }}</afi-badge>
          </div>
        ...
        <section>
          ...
          <p class="text-body-md text-neutral-600 mb-space-8">
            Badge dentro de NavItem para notificaciones. Badge dot junto a un avatar para estado en
            línea. Badge en columnas de DataTable para categorizar filas.
          </p>
      ...
      <div slot="design-tab">
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            <li>
              El badge usa <code class="font-mono text-action-700">role="status"</code> para
              anunciar cambios a lectores de pantalla.
            </li>
            <li>
              En modo dot, proporcione <code class="font-mono text-action-700">ariaLabel</code> para
              comunicar el significado del indicador.
            </li>
            <li>El contraste de color cumple WCAG AA en todas las variantes de intención.</li>
            <li>
              No dependa únicamente del color para comunicar el estado — acompañe con texto o icono.
            </li>
          </ul>
          ...
          <div class="space-y-space-3 mb-space-8">
            <p class="text-body-md text-neutral-600">
              El badge no es interactivo, por lo tanto no recibe foco de teclado.
            </p>
          </div>
          ...
          >
            ...
            <code class="text-body-sm font-mono text-neutral-600"
              >role="status" · "3 errores pendientes"</code
            >
          </div>
        </section>
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-6">
            <li>
              Transición de propiedades: <code class="font-mono">var(--duration-fast)</code> (150ms)
          ...
          >
            ...
            <span class="text-body-sm text-neutral-500"
              >Variantes de intención con transición suave.</span
            >
          </div>
        </section>
          ...
          <div class="space-y-space-4">
            ...
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">
                  Contenido breve y numérico para contadores.
                </p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                ...
                <div class="mb-space-2">
                  <afi-badge intent="error">Hay 3 errores en el formulario</afi-badge>
                </div>
                <p class="text-body-sm text-neutral-600">
                  Texto largo desborda el badge. Use un mensaje aparte.
                </p>
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">
                  Usar intención semántica acorde al significado.
                </p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                <p class="text-body-sm font-medium text-system-error mb-space-2">Incorrecto</p>
                ...
                <p class="text-body-sm text-neutral-600">
                  Intención invertida confunde al usuario.
                </p>
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                <p class="text-body-sm font-medium text-system-success mb-space-2">Correcto</p>
                <div class="mb-space-2">
                  <afi-badge intent="error" [dot]="true" ariaLabel="Tiene errores" />
                </div>
                <p class="text-body-sm text-neutral-600">
                  Dot con ariaLabel para lectores de pantalla.
                </p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                <p class="text-body-sm font-medium text-system-error mb-space-2">Incorrecto</p>
                ...
                <p class="text-body-sm text-neutral-600">
                  Dot sin ariaLabel es invisible para lectores de pantalla.
                </p>
              </div>
            </div>
          </div>
  ...
  readonly apiInputs = [
    {
      ...
      default: "'neutral'",
      notes: 'Intención semántica del color',
    },
    { name: 'size', type: "'sm' | 'md'", default: "'md'", notes: 'Tamaño del badge' },
    {
      ...
      type: 'boolean',
      default: 'false',
      notes: 'Modo indicador sin texto (solo punto)',
    },
    { name: 'icon', type: 'string | null', default: 'null', notes: 'Icono antes del contenido' },
    {
      ...
      type: 'string | null',
      default: 'null',
      notes: 'Etiqueta accesible (requerida en modo dot)',
    },
  ];
}
