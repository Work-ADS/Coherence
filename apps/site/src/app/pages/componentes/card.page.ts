      ...
      <div slot="code-tab">
        ...
        <afi-component-playground [code]="codeSnippet()">
          <div slot="controls" class="space-y-space-4">
            ...
            <fieldset>
              ...
              @for (v of variants; track v) {
                <label class="flex items-center gap-2 py-0.5 cursor-pointer text-body-sm">
                  <input type="radio" name="variant" [value]="v" [checked]="variant() === v" (change)="variant.set(v)" class="accent-action" />
                  {{ v }}
                </label>
              }
            </fieldset>
            ...
            <!-- Padding -->
            <fieldset>
              <legend class="font-medium text-canvas-fg mb-space-1 text-body-sm">Padding</legend>
              @for (p of paddings; track p) {
                <label class="flex items-center gap-2 py-0.5 cursor-pointer text-body-sm">
                  <input type="radio" name="padding" [value]="p" [checked]="padding() === p" (change)="padding.set(p)" class="accent-action" />
                  {{ p }}
                </label>
              }
            </fieldset>
            ...
            <fieldset>
              ...
              <label class="flex items-center gap-2 py-0.5 cursor-pointer text-body-sm">
                <input type="checkbox" [checked]="interactive()" (change)="interactive.set(!interactive())" class="accent-action" />
                interactive
              </label>
            </fieldset>
          </div>
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            ...
            <li>Tarjeta interactiva que navega a un detalle (con <code class="font-mono">interactive</code>).</li>
          </ul>
          ...
          <p class="text-body-md text-neutral-600 mb-space-8">
            Grid de Cards para dashboards. Card con LoadingOverlay para carga asíncrona.
            Card con header + Table para listados con título.
          </p>
      ...
      <div slot="design-tab">
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            ...
            <li>Card interactiva: <code class="font-mono text-action-700">role="button"</code>, <code class="font-mono text-action-700">tabindex="0"</code>.</li>
            <li>Siempre proporcione <code class="font-mono text-action-700">ariaLabel</code> cuando interactive es true.</li>
          ...
          <div class="space-y-space-3 mb-space-8">
            <div class="flex items-center gap-space-3">
              ...
              <span class="text-body-md text-neutral-600">Enfoca la tarjeta (solo interactive)</span>
            </div>
            <div class="flex items-center gap-space-3">
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-6">
            <li>Hover shadow (interactive): <code class="font-mono">var(--duration-fast)</code> ease-out.</li>
          ...
          <div class="space-y-space-4">
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">Use variant "default" con borde para separar del fondo.</p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">Anidar Cards dentro de Cards — genera ruido visual.</p>
              </div>
            </div>
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                <p class="text-body-sm font-medium text-system-success mb-space-2">Correcto</p>
                <p class="text-body-sm text-neutral-600">Use interactive + ariaLabel para tarjetas clickeables.</p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                <p class="text-body-sm font-medium text-system-error mb-space-2">Incorrecto</p>
                <p class="text-body-sm text-neutral-600">Card interactiva sin ariaLabel — inaccesible para lectores.</p>
              </div>
            </div>
          </div>
        </section>
...
export class CardPage {
  ...
  readonly apiInputs = [
    { name: 'variant', type: "'default' | 'elevated' | 'quiet'", default: "'default'", notes: 'Estilo visual' },
    { name: 'padding', type: "'none' | 'sm' | 'md' | 'lg'", default: "'md'", notes: 'Padding del body' },
    { name: 'interactive', type: 'boolean', default: 'false', notes: 'Hace la tarjeta clickeable' },
    { name: 'ariaLabel', type: 'string | null', default: 'null', notes: 'Etiqueta accesible (requerido si interactive)' },
  ];

  readonly apiOutputs = [
    { name: 'clicked', payload: '{ event: MouseEvent | KeyboardEvent }', notes: 'Emitido al hacer click (solo interactive)' },
  ];
}
