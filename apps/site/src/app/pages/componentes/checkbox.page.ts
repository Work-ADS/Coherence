    ...
    >
      ...
      <div slot="code-tab">
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            <li>
              Encendido/apagado con efecto inmediato — use
              <code class="font-mono">&lt;afi-switch&gt;</code>.
            </li>
            <li>Selección exclusiva (una opción de varias) — use radio buttons.</li>
            <li>
              Selección de un valor de una lista larga — use
          ...
          <p class="text-body-md text-neutral-600 mb-space-8">
            Grupo de Checkbox para filtros. Checkbox indeterminado como selector de fila padre en
            Table. Checkbox + label + hint para términos legales.
          </p>
      ...
      <div slot="design-tab">
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            <li>
              Usa
              <code class="font-mono text-action-700">&lt;input type="checkbox"&gt;</code> nativo —
              nunca un <code class="font-mono">&lt;div&gt;</code> con role.
            </li>
            <li>
              Siempre incluya un <code class="font-mono text-action-700">label</code> visible, salvo
              en tablas donde <code class="font-mono text-action-700">ariaLabel</code> es
              suficiente.
            </li>
            ...
            <li>
              ...
              texto de error con <code class="font-mono">role="alert"</code>.
            </li>
            <li>
          ...
          >
            ...
            <code class="block text-body-sm font-mono text-neutral-600"
              >aria-invalid="true" · aria-required="true" · role="alert"</code
            >
          </div>
        </section>
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-6">
            <li>
              Marca de verificación SVG: animación de trazo (<code class="font-mono"
                >stroke-dashoffset</code
              >) 200ms con retardo de 80ms.
            </li>
            <li>Trazo indeterminado: 150ms con el mismo retardo.</li>
            <li>
              Caja: transición de color 150ms <code class="font-mono">ease-out</code> + escala
              elástica 250ms <code class="font-mono">cubic-bezier(0.34, 1.56, 0.64, 1)</code>.
            </li>
          ...
          >
            ...
            <span class="text-body-sm text-neutral-500"
              >Observe la animación del trazo al marcar y desmarcar.</span
            >
          </div>
        </section>
          ...
          <div class="space-y-space-4">
            ...
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                ...
                <div class="mb-space-2">
                  <afi-checkbox label="Recibir notificaciones por correo" />
                </div>
                <p class="text-body-sm text-neutral-600">
                  Checkbox para opciones que el usuario activa o desactiva.
                </p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">
                  Use Switch para ajustes con efecto inmediato.
                </p>
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                <p class="text-body-sm font-medium text-system-success mb-space-2">Correcto</p>
                <div class="mb-space-2">
                  <afi-checkbox label="Acepto los términos" [required]="true" />
                </div>
              ...
              <div class="p-space-4 border border-system-error rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">
                  Sin label visible el usuario no sabe qué acepta.
                </p>
              </div>
            </div>
          </div>
...
/>`;
  ...
  readonly apiInputs = [
    { name: 'checked', type: 'boolean', default: 'false', notes: 'Estado marcado' },
    {
      ...
      type: 'boolean',
      default: 'false',
      notes: 'Estado indeterminado (fila padre de Table)',
    },
