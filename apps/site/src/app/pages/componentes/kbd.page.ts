    ...
    >
      ...
      <div slot="code-tab">
        ...
        <afi-component-playground [code]="codeSnippet()">
          ...
          <div slot="preview" class="flex items-center gap-space-4">
            <afi-kbd [keys]="keys()" [size]="size()" [separator]="separator()" />
          </div>
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            <li>
              Indicar atajos de teclado en menús contextuales (<code class="font-mono">⌘ K</code>).
            </li>
            ...
            <li>
              Prosa inline: "Pulse <code class="font-mono">&lt;afi-kbd&gt;</code> para abrir el
              buscador."
            </li>
          </ul>
          ...
          <p class="text-body-md text-neutral-600 mb-space-8">
            Kbd dentro de MenuItem como indicador de shortcut. Kbd junto al campo de búsqueda
            (patrón ⌘K). Kbd en la sección "Mapa de teclado" de páginas de documentación.
          </p>
        ...
        <!-- Gallery -->
        <section>
          <h2 id="galeria" class="text-section text-canvas-fg mb-space-6">Galería</h2>
      ...
      <div slot="design-tab">
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            <li>
              Cada tecla usa <code class="font-mono text-action-700">&lt;kbd&gt;</code> nativo
              (HTML5 semántico).
            </li>
            <li>
              El wrapper usa <code class="font-mono text-action-700">role="group"</code> para
              agrupar teclas como un acorde.
            </li>
            <li>
              El <code class="font-mono text-action-700">aria-label</code> se genera
              automáticamente: "Atajo de teclado: ⌘ más K".
            </li>
            <li>
              Los separadores son <code class="font-mono text-action-700">aria-hidden="true"</code>.
            </li>
            <li>No es enfocable (display-only, sin <code class="font-mono">tabindex</code>).</li>
          </ul>

          <h3 id="glosario-sr" class="text-body-md font-medium text-canvas-fg mb-space-4">
            Glosario para lectora de pantalla
          </h3>
          <div class="overflow-x-auto rounded-lg border border-border-hairline mb-space-8">
            <table class="w-full text-body-sm">
              <thead>
            ...
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">
                  Usar símbolos Unicode estándar para teclas modificadoras.
                </p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">
                  Texto plano sin keycap visual pierde la affordance de teclado.
                </p>
              </div>
            </div>
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                <p class="text-body-sm font-medium text-system-success mb-space-2">Correcto</p>
                <p class="text-body-sm text-neutral-600">
                  Kbd dentro de MenuItem para indicar shortcut.
                </p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                <p class="text-body-sm font-medium text-system-error mb-space-2">Incorrecto</p>
                <p class="text-body-sm text-neutral-600">
                  Kbd como label de un botón — los botones no son teclas.
                </p>
              </div>
            </div>
          </div>
  ...
  readonly apiInputs = [
    {
      ...
      type: 'string[]',
      default: '(required)',
      notes: 'Cada string es UNA tecla. Acepta símbolos Unicode.',
    },
    { name: 'size', type: "'sm' | 'md'", default: "'sm'", notes: 'sm = 20px, md = 24px' },
    {
      name: 'separator',
      type: "'none' | 'plus' | 'arrow'",
      default: "'none'",
      notes: 'Carácter entre teclas: nada / + / →',
    },
    {
      name: 'ariaLabel',
      type: 'string | null',
      default: 'null',
      notes: 'Sobrescribe el aria-label auto-generado',
    },
  ];
