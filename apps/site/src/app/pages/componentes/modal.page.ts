...
import { ModalComponent } from '@coherence/ui';
    ...
    >
      ...
      <div slot="code-tab">
        ...
        <afi-component-playground [code]="codeSnippet()">
          <div slot="controls" class="space-y-space-4">
            ...
            <fieldset>
              ...
              <label class="flex items-center gap-2 py-0.5 cursor-pointer text-body-sm">
                <input type="checkbox" [checked]="closeOnBackdrop()" (change)="closeOnBackdrop.set(!closeOnBackdrop())" class="accent-action" />
                closeOnBackdrop
              </label>
              <label class="flex items-center gap-2 py-0.5 cursor-pointer text-body-sm">
                <input type="checkbox" [checked]="closeOnEsc()" (change)="closeOnEsc.set(!closeOnEsc())" class="accent-action" />
                closeOnEsc
              </label>
            </fieldset>
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            <li>Contenido extenso o formularios largos — use <code class="font-mono">&lt;afi-drawer&gt;</code> o una página dedicada.</li>
          ...
          <p class="text-body-md text-neutral-600 mb-space-8">
            Modal de confirmación con dos botones (Cancelar / Confirmar). Modal de formulario
            con inputs y validación. Modal de alerta con un solo botón de aceptar.
          </p>
      ...
      <div slot="design-tab">
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            <li>Usa <code class="font-mono text-action-700">&lt;dialog&gt;</code> nativo — focus trap y scroll lock incluidos.</li>
            <li><code class="font-mono text-action-700">aria-labelledby</code> apunta al título del modal.</li>
            <li><code class="font-mono text-action-700">aria-describedby</code> apunta a la descripción si existe.</li>
            <li>Botón de cerrar con <code class="font-mono text-action-700">aria-label="Cerrar"</code>.</li>
            <li>Al cerrar, el foco regresa al elemento que disparó la apertura.</li>
            <li>Esc cierra el modal por defecto (configurable con <code class="font-mono">closeOnEsc</code>).</li>
          </ul>
          ...
          <div class="space-y-space-3 mb-space-8">
            <div class="flex items-center gap-space-3">
              ...
              <span class="text-body-md text-neutral-600">Navega entre elementos focusables dentro del modal</span>
            </div>
            <div class="flex items-center gap-space-3">
              <kbd class="px-2 py-1 bg-neutral-100 border border-border-hairline rounded text-body-sm font-mono">Esc</kbd>
              <span class="text-body-md text-neutral-600">Cierra el modal (si closeOnEsc es true)</span>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-6">
            ...
            <li>Panel: aparición instantánea (sin animación adicional — el nativo es suficiente).</li>
          ...
          <div class="space-y-space-4">
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">Use modal para confirmaciones que requieren atención inmediata.</p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">Modal para contenido largo — use Drawer o página dedicada.</p>
              </div>
            </div>
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
              ...
              <div class="p-space-4 border border-system-error rounded-md">
                <p class="text-body-sm font-medium text-system-error mb-space-2">Incorrecto</p>
                <p class="text-body-sm text-neutral-600">Anidar modales — confunde al usuario y al lector de pantalla.</p>
              </div>
            </div>
          </div>
        </section>
...
>
  ...
  readonly apiInputs = [
    ...
    { name: 'description', type: 'string | null', default: 'null', notes: 'Descripción bajo el título' },
    { name: 'closeOnEsc', type: 'boolean', default: 'true', notes: 'Cierra con Esc' },
    { name: 'closeOnBackdrop', type: 'boolean', default: 'false', notes: 'Cierra al clic en backdrop' },
