...
import { RadioGroupComponent, RadioGroupItemComponent, CheckboxComponent } from '@coherence/ui';
    ...
    >
      ...
      <div slot="code-tab">
        ...
        <section>
          ...
          <h3 id="radio-group-inputs" class="text-body-md font-medium text-canvas-fg mb-space-4">
            RadioGroup — Entradas
          </h3>
          ...
          <h3 id="radio-item-inputs" class="text-body-md font-medium text-canvas-fg mb-space-4">
            RadioGroupItem — Entradas
          </h3>
          <div class="overflow-x-auto rounded-lg border border-border-hairline mb-space-8">
            <table class="w-full text-body-sm">
              <thead>
            ...
            <table class="w-full text-body-sm">
              ...
              <tbody>
                @for (row of apiOutputs; track row.name) {
                  <tr class="border-b border-border-hairline last:border-b-0">
                    <td class="px-space-4 py-space-3 font-mono text-action-700">
                      {{ row.component }}
                    </td>
                    <td class="px-space-4 py-space-3 font-mono text-action-700">{{ row.name }}</td>
      ...
      <div slot="design-tab">
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            <li>
              Usa <code class="font-mono text-action-700">&lt;input type="radio"&gt;</code> nativo
              dentro de un <code class="font-mono text-action-700">&lt;fieldset&gt;</code> con
              <code class="font-mono">role="radiogroup"</code>.
            </li>
            <li>
              Cada opción debe tener un
              <code class="font-mono text-action-700">label</code> visible.
            </li>
            <li>
              El grupo necesita una <code class="font-mono text-action-700">legend</code> o
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-6">
            <li>
              Punto interior: escala elástica 250ms
              <code class="font-mono">cubic-bezier(0.34, 1.56, 0.64, 1)</code> — efecto rebote al
              seleccionar.
            </li>
            <li>
              Anillo exterior: transición de color 150ms <code class="font-mono">ease-out</code>.
            </li>
            <li>Reduced motion: todas las transiciones colapsan a 0ms.</li>
          </ul>
          <div
            class="flex flex-col gap-space-2 p-space-4 bg-neutral-50 rounded-md border border-border-hairline"
          >
            ...
            <span class="text-body-sm text-neutral-500"
              >Observe la animación elástica del punto al seleccionar.</span
            >
          </div>
        </section>
          ...
          <div class="space-y-space-4">
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                ...
                <p class="text-body-sm text-neutral-600 mt-space-2">
                  Radio para selección exclusiva entre pocas opciones.
                </p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">
                  No use radio para selección múltiple — use Checkbox.
                </p>
              </div>
            </div>
          </div>
...
export class RadioGroupPage {
  ...
  readonly groupApiInputs = [
    ...
    { name: 'disabled', type: 'boolean', default: 'false', notes: 'Desactiva todo el grupo' },
    {
      ...
      type: 'string | null',
      default: 'null',
      notes: 'Label para lectoras de pantalla',
    },
    {
      name: 'ariaLabelledBy',
      type: 'string | null',
      default: 'null',
      notes: 'ID del elemento que etiqueta el grupo',
    },
  ];
  ...
  readonly itemApiInputs = [
    ...
    { name: 'size', type: "'sm' | 'md'", default: "'md'", notes: 'Tamaño del indicador' },
    {
      ...
      type: 'string',
      default: "''",
      notes: 'Nombre del grupo (agrupa los radios nativos)',
    },
    {
      name: 'selected',
      type: 'boolean',
      default: 'false',
      notes: 'Si esta opción está seleccionada',
    },
  ];
  ...
  readonly apiOutputs = [
    {
      ...
      name: 'valueChange',
      payload: 'string',
      notes: 'Emitido al cambiar la selección',
    },
    {
      component: 'RadioGroupItem',
      name: 'selectedChange',
      payload: 'string',
      notes: 'Emitido cuando este item es seleccionado',
    },
  ];
}
