    ...
    >
      ...
      <div slot="code-tab">
          ...
          <div slot="controls" class="space-y-space-4">
            ...
            <div>
              ...
              <afi-input
                size="sm"
                [value]="hintText()"
                (valueChange)="hintText.set($event?.toString() ?? '')"
              />
            </div>
          </div>
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            <li>
              Activar o desactivar un ajuste con efecto inmediato (modo oscuro, notificaciones).
            </li>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            <li>
              Selección que requiere confirmación (formulario con botón enviar) — use
          ...
          <p class="text-body-md text-neutral-600 mb-space-8">
            Switch en panel de configuración. Switch con label + hint para ajustes con descripción
            extendida. Grupo de switches en sección de preferencias.
          </p>
      ...
      <div slot="design-tab">
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-8">
            <li>
              Usa <code class="font-mono text-action-700">&lt;button role="switch"&gt;</code> — no
              un checkbox ni un div.
            </li>
            <li>
              <code class="font-mono text-action-700">aria-checked</code> refleja el estado actual
              (true/false).
            </li>
            <li>
              Siempre incluya un label visible o
              <code class="font-mono text-action-700">ariaLabel</code>.
            </li>
            <li>
              Hint enlazado vía <code class="font-mono text-action-700">aria-describedby</code>.
            </li>
          ...
          <div class="space-y-space-3 mb-space-8">
            ...
            <div class="flex items-center gap-space-3">
              ...
              <span class="text-body-md text-neutral-600"
                >Alterna el estado (click nativo del button)</span
              >
            </div>
          </div>
          ...
          >
            ...
            <code class="block text-body-sm font-mono text-neutral-600"
              >role="switch" · aria-checked="true" · aria-describedby="…-hint"</code
            >
          </div>
        </section>
        ...
        <section>
          ...
          <ul class="list-disc pl-space-6 text-body-md text-neutral-600 space-y-space-2 mb-space-6">
            <li>
              Transición del thumb: <code class="font-mono">var(--duration-fast)</code> (150ms)
            ...
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">
                  Switch para ajustes con efecto inmediato.
                </p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                ...
                <p class="text-body-sm text-neutral-600">
                  Use Checkbox para consentimiento que requiere confirmación.
                </p>
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-space-4">
              <div class="p-space-4 border border-system-success rounded-md">
                ...
                <div class="mb-space-2">
                  <afi-switch label="Notificaciones push" hint="Reciba alertas en tiempo real." />
                </div>
                <p class="text-body-sm text-neutral-600">
                  Label + hint describe claramente el efecto.
                </p>
              </div>
              <div class="p-space-4 border border-system-error rounded-md">
                <p class="text-body-sm font-medium text-system-error mb-space-2">Incorrecto</p>
                ...
                <p class="text-body-sm text-neutral-600">
                  Sin label visible el usuario no entiende el contexto.
                </p>
              </div>
            </div>
          </div>
...
/>`;
  ...
  readonly apiInputs = [
    ...
    { name: 'label', type: 'string | null', default: 'null', notes: 'Texto visible del label' },
    {
      ...
      type: 'string | null',
      default: 'null',
      notes: 'Texto de ayuda (aria-describedby)',
    },
