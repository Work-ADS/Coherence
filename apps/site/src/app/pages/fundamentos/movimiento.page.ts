  ...
  template: `
    <div class="max-w-[920px] mx-auto px-space-10 py-space-12">
      ...
      <p class="text-body-md text-neutral-500 max-w-[640px] mb-space-10">
        Motion en Coherence comunica estado, no decora. Siete reglas de disciplina gobiernan cada
        transición. El sitio de documentación es el único lugar donde el movimiento decorativo está
        autorizado.
      </p>
      ...
      <section class="mb-space-12">
        <h2 id="siete-reglas" class="text-section text-canvas-fg mb-space-6">
          Siete reglas de disciplina
        </h2>
      ...
      <!-- Duration tokens -->
      <section class="mb-space-12">
        <h2 id="tokens-de-duracion" class="text-section text-canvas-fg mb-space-6">
          Tokens de duración
        </h2>
      ...
      <!-- Easing tokens -->
      <section class="mb-space-12">
        <h2 id="tokens-de-easing" class="text-section text-canvas-fg mb-space-6">
          Tokens de easing
        </h2>
        <div class="overflow-x-auto max-w-[720px]">
          <table class="w-full text-body-sm">
      ...
      <!-- 3 tiers -->
      <section class="mb-space-12">
        <h2 id="tres-niveles" class="text-section text-canvas-fg mb-space-6">
          Tres niveles de implementación
        </h2>
        <div class="flex flex-col gap-space-4 max-w-[720px]">
          <div class="p-space-4 border border-action-500 rounded-md bg-surface-quiet">
            <p class="text-body-sm-600 text-canvas-fg mb-space-1">
              Nivel 1 — CSS Transitions (95%)
            </p>
            <p class="text-body-sm text-neutral-600">
              <code class="font-mono"
                >transition: all var(--duration-fast) var(--easing-standard)</code
      ...
      <!-- Reduced motion -->
      <section class="mb-space-12">
        <h2 id="movimiento-reducido" class="text-section text-canvas-fg mb-space-6">
          Movimiento reducido
        </h2>
        <p class="text-body-md text-neutral-600 max-w-[640px] mb-space-6">
          <code class="font-mono text-body-sm">prefers-reduced-motion: reduce</code> colapsa cada
          transición a 0–80ms de fade. Se preserva la comunicación de estado — se elimina el
          desplazamiento. Una sola regla CSS global lo maneja.
        </p>
      ...
      <!-- Live demo -->
      <section class="mb-space-12">
        <h2 id="demostracion" class="text-section text-canvas-fg mb-space-6">Demostración</h2>
        <p class="text-body-md text-neutral-600 max-w-[640px] mb-space-6">
          Pase el cursor sobre los elementos para ver las transiciones en acción.
        </p>
        <div class="flex gap-space-6 max-w-[720px]">
          <button
            class="px-space-6 py-space-3 bg-action-500 text-canvas-fg-on-action rounded-md
          ...
          <button
            class="px-space-6 py-space-3 border border-border-hairline rounded-md
        ...
        <ul class="text-body-sm text-action-700 space-y-space-2">
          ...
          <li>
            <a routerLink="/componentes/button" class="underline hover:text-action-800"
              >Button (consumidor de motion)</a
            >
          </li>
          <li>
            <a routerLink="/componentes/modal" class="underline hover:text-action-800"
              >Modal (enter/exit animation)</a
            >
          </li>
        </ul>
...
export class MovimientoPage {
  readonly rules = [
    {
      num: 1,
      title: 'Contenedor primero',
      desc: 'Anime el objeto como unidad — borde, fondo y label juntos. Nunca texto suelto dentro de un contenedor estático.',
    },
    {
      num: 2,
      title: 'Mínimas propiedades',
      desc: 'Prefiera transform + opacity (GPU-composited, sin layout). Evite animar width / height / top / left.',
    },
    {
      num: 3,
      title: 'Ease correcto',
      desc: 'ease-out para entradas (settling in). ease-in para salidas (accelerating away). ease-in-out para ida y vuelta.',
    },
    {
      num: 4,
      title: 'Duración proporcional al peso',
      desc: 'Chip focus: 80–150ms. Button hover: 150–200ms. Modal enter: 200–300ms. Nunca > 400ms para respuesta interactiva.',
    },
    {
      num: 5,
      title: 'Respete el estado de reposo',
      desc: 'Hover / pressed / focus se leen como variantes del default, no como reemplazos.',
    },
    {
      num: 6,
      title: 'No anime lo que no ha decidido',
      desc: 'La animación clarifica intención; animación aleatoria la confunde. Si el propósito no es claro, déjelo estático.',
    },
    {
      num: 7,
      title: 'Movimiento reducido = respeto',
      desc: 'prefers-reduced-motion: reduce colapsa a 0–80ms fades. Preservar comunicación de estado, eliminar desplazamiento.',
    },
  ];
}
