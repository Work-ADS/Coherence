  ...
  template: `
    <div class="max-w-[920px] mx-auto px-space-10 py-space-12">
      ...
      <p class="text-body-md text-neutral-500 max-w-[640px] mb-space-10">
        Las convicciones que guían cada decisión de diseño en Coherence — por qué existe este sistema,
        para quién trabaja y cómo se alinea con la forma de construir de AFI.
      </p>
      ...
      <section class="mb-space-12">
        <h2 id="estrella-norte" class="text-section text-canvas-fg mb-space-4">Estrella norte</h2>
        <blockquote class="border-l-2 border-action-500 pl-space-6 py-space-2 text-body-md italic text-canvas-fg max-w-[640px] mb-space-6">
          Un sistema de diseño que los desarrolladores realmente usan — porque está construido para cómo
          <em>ellos</em> consumen información, no para cómo los diseñadores desearían que lo hicieran.
        </blockquote>
        <p class="text-body-md text-neutral-600 max-w-[640px]">
          ...
          tokens y documentación directamente donde el equipo de desarrollo ya trabaja: en el código,
          en la terminal, en el IDE.
        </p>
      </section>

      <!-- El cambio -->
      <section class="mb-space-12">
        <h2 id="el-cambio" class="text-section text-canvas-fg mb-space-4">El cambio</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-space-6 max-w-[720px]">
          <div class="p-space-6 border border-border-hairline rounded-md">
            ...
            <p class="text-body-sm text-neutral-500">
              Variables se pierden en el handoff. El diseñador absorbe la prisa y la culpa.
              Los desarrolladores no consultan Figma, ni DevMode, ni documentación.
            </p>
          </div>
          <div class="p-space-6 border border-action-500 rounded-md bg-surface-quiet">
            ...
            <p class="text-body-sm text-neutral-500">
              Un archivo MD es la fuente de verdad. Los agentes de IA lo leen, el sitio lo renderiza,
              el equipo lo descarga. Un cambio actualiza todo.
            </p>
          </div>
        </div>
      </section>
      ...
      <!-- División de trabajo -->
      <section class="mb-space-12">
        <h2 id="division-de-trabajo" class="text-section text-canvas-fg mb-space-4">División de trabajo</h2>
        <p class="text-body-md text-neutral-600 max-w-[640px] mb-space-6">
      ...
      <section class="mb-space-12">
        <h2 id="ia-como-guia" class="text-section text-canvas-fg mb-space-4">IA como guía socrática</h2>
        <p class="text-body-md text-neutral-600 max-w-[640px] mb-space-6">
      ...
      <!-- Identidad visual -->
      <section class="mb-space-12">
        <h2 id="identidad-visual" class="text-section text-canvas-fg mb-space-4">Identidad visual</h2>
        <p class="text-body-md text-neutral-600 max-w-[640px] mb-space-6">
          Innovador pero con clase. Moderno pero culto. El registro editorial de Coherence se
          inspira en revistas como The New Yorker y Monocle aplicadas al software: tipografía primero,
          color con moderación, líneas horizontales sobre cajas, peso y tracking sobre tamaño.
        </p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-space-4 max-w-[720px]">
          <div class="p-space-4 border border-border-hairline rounded-md">
            ...
            <p class="text-body-sm text-neutral-500">Compacta, disciplinada, organizada. Ref: Figma.</p>
          </div>
          <div class="p-space-4 border border-border-hairline rounded-md">
            <p class="text-body-sm-600 text-canvas-fg mb-space-1">Tipografía</p>
            <p class="text-body-sm text-neutral-500">Roboto Serif en toda la jerarquía. Ref: Granola.</p>
          </div>
          <div class="p-space-4 border border-border-hairline rounded-md">
            <p class="text-body-sm-600 text-canvas-fg mb-space-1">Color</p>
            <p class="text-body-sm text-neutral-500">Base monocromática neutra + acentos estratégicos. Ref: Wise.</p>
          </div>
        </div>
      </section>
      ...
      <!-- Criterios de éxito -->
      <section class="mb-space-12">
        <h2 id="criterios-de-exito" class="text-section text-canvas-fg mb-space-4">Criterios de éxito</h2>
        <ul class="list-disc list-inside text-body-md text-neutral-600 max-w-[640px] space-y-space-2">
