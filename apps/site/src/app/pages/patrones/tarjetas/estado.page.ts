...
@Component({
  ...
  template: `
    <div class="max-w-[920px] mx-auto px-space-10 py-space-12">
      ...
      <h1 class="text-title text-canvas-fg mb-space-3">Estado</h1>
      <p class="max-w-[640px] text-body-md text-neutral-600 mb-space-8">
        Card que muestra un label de estado con visual de confirmación opcional (checkmark, progreso).
      </p>
      ...
      <section class="mb-space-8">
        ...
        <p class="max-w-[640px] text-body-md text-neutral-600 mb-space-4">
          Un status chip prominente indica el estado actual (completado, pendiente, en progreso, error).
          Opcionalmente, un visual de confirmación acompaña el chip: checkmark animado para éxito,
          barra de progreso para estados intermedios, o icono de alerta para errores.
        </p>
      </section>
      ...
      <section class="mb-space-8">
        ...
        <ul class="max-w-[640px] list-disc pl-space-5 text-body-md text-neutral-600 space-y-space-1">
          ...
          <li><code>afi-status-chip</code> — indicador de estado</li>
          <li><code>afi-badge</code> — metadata adicional (timestamp, ID)</li>
        </ul>
      </section>
      ...
      <section class="mb-space-8">
        ...
        <ul class="max-w-[640px] list-disc pl-space-5 text-body-md text-neutral-600 space-y-space-1">
          <li>Estado de orden (pendiente → procesando → completado).</li>
          <li>Estado de deployment o build (success, failed, running).</li>
          <li>Workflows de aprobación con estado actual.</li>
        </ul>
      </section>
      ...
      <section class="mb-space-8">
        ...
        <ul class="max-w-[640px] list-disc pl-space-5 text-body-md text-neutral-600 space-y-space-1">
          <li>Historial detallado de cambios de estado — usa una tabla o timeline.</li>
          <li>Estado editable — usa un Select o formulario.</li>
          <li>Múltiples estados simultáneos — usa <strong>Lista de indicadores</strong>.</li>
        </ul>
      </section>
      ...
      <section class="mb-space-8">
        ...
        <div class="grid grid-cols-2 gap-space-4">
          <div class="rounded-lg border border-success-300 bg-success-50 p-space-4">
            ...
            <p class="text-body-sm text-neutral-700">Usa colores semánticos consistentes (verde=éxito, rojo=error, amarillo=pendiente).</p>
          </div>
          <div class="rounded-lg border border-danger-300 bg-danger-50 p-space-4">
            ...
            <p class="text-body-sm text-neutral-700">No dependas solo del color — incluye siempre un label de texto.</p>
          </div>
          <div class="rounded-lg border border-success-300 bg-success-50 p-space-4">
            <p class="text-body-sm font-semibold text-success-700 mb-space-2">✓ Do</p>
            <p class="text-body-sm text-neutral-700">Incluye timestamp del último cambio de estado cuando sea relevante.</p>
          </div>
          <div class="rounded-lg border border-danger-300 bg-danger-50 p-space-4">
            <p class="text-body-sm font-semibold text-danger-700 mb-space-2">✗ Don't</p>
            <p class="text-body-sm text-neutral-700">No permitas cambiar el estado directamente desde la tarjeta — es informativa.</p>
          </div>
        </div>
      </section>
