import { Component, ChangeDetectionStrategy, HostListener, signal, viewChild } from '@angular/core';
  ...
  template: `
    <main class="px-space-10 py-space-10 max-w-[920px] mx-auto">
      <header class="mb-space-10 pb-space-8 border-b border-border-hairline">
        <p class="text-body-sm uppercase tracking-wider text-action-700 mb-space-3">Coherence DS</p>
        <h1 class="text-subtitle text-canvas-fg mb-space-3">Galería de primitivos</h1>
        <p class="text-body text-neutral-600 max-w-[640px]">
          Vista previa de todos los primitivos enviados hasta la fecha. Cada tarjeta muestra un
          componente con sus variantes principales.
        </p>
      </header>
      ...
      <div class="flex flex-col">
        ...
        >
          <div class="flex items-start gap-space-4">
            <div
              class="relative w-[200px] h-[120px] border border-border-hairline rounded-md overflow-hidden"
            >
              <afi-loading-overlay
                [visible]="overlayDemo()"
        ...
        >
          <div class="w-full border border-border-hairline rounded-md overflow-hidden">
            <afi-page-header
              ...
              density="default"
            >
              <span slot="breadcrumb" class="text-body-sm text-neutral-500"
                >Personas / Cliente</span
              >
              <afi-button slot="primaryAction" variant="primary" size="sm"
                >Enviar ajuste</afi-button
              >
            </afi-page-header>
          </div>
        </afi-primitive-card>
        ...
        >
          ...
          >
            ...
            <div
              slot="footer"
              class="flex justify-end gap-space-2 px-space-4 py-space-3 border-t border-border-hairline"
            >
        ...
        <!-- Sidebar + NavItem (interactive demo) -->
        <afi-primitive-card
          name="Sidebar + NavItem"
          description="Barra de navegación principal. Demo interactiva en modo collapsible con atajo de teclado y tooltips al colapsar."
        >
          <div
            class="h-[420px] w-full border border-border-hairline rounded-md overflow-hidden flex"
          >
            <afi-sidebar
              #sidebarDemo
              mode="collapsible"
              ariaLabel="Navegación de ejemplo"
              (expandedChange)="sidebarExpanded.set($event)"
            >
              <span slot="top" class="text-body-md font-medium truncate">Coherence</span>

              <afi-nav-item label="Familia" [sidebarExpanded]="sidebarExpanded()">
                <svg
                  slot="icon"
                  class="w-5 h-5"
                  viewBox="0 0 20 20"
                ...
                >
                  <path
                    d="M7 9a3 3 0 100-6 3 3 0 000 6zm6-2a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zM1.615 16.428a1.224 1.224 0 01-.569-1.175 6.002 6.002 0 0111.908 0c.058.467-.172.92-.57 1.174A9.953 9.953 0 017 18a9.953 9.953 0 01-5.385-1.572zM14.5 16h-.106c.07-.297.088-.611.048-.933a7.47 7.47 0 00-1.588-3.755 4.502 4.502 0 015.874 2.636.818.818 0 01-.36.98A7.465 7.465 0 0114.5 16z"
                  />
                </svg>
              </afi-nav-item>

              <afi-nav-item label="Patrimonio" [sidebarExpanded]="sidebarExpanded()">
                <svg
                  slot="icon"
                  class="w-5 h-5"
                  viewBox="0 0 20 20"
                ...
                >
                  <path
                    d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4zM18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zm-5 3a1 1 0 100 2h2a1 1 0 100-2h-2z"
                  />
                </svg>
              </afi-nav-item>

              <afi-nav-item label="Ingresos" [sidebarExpanded]="sidebarExpanded()">
                <svg
                  slot="icon"
                  class="w-5 h-5"
                  viewBox="0 0 20 20"
                ...
                >
                  <path
                    fill-rule="evenodd"
                    d="M12 7a.75.75 0 01.75-.75h5a.75.75 0 01.75.75v5a.75.75 0 01-1.5 0V8.81l-5.47 5.47a.75.75 0 01-1.06 0L8 11.31l-4.72 4.72a.75.75 0 11-1.06-1.06l5.25-5.25a.75.75 0 011.06 0L11 12.19l4.94-4.94H12.75A.75.75 0 0112 7z"
                    clip-rule="evenodd"
                  />
                </svg>
              </afi-nav-item>

              <afi-nav-item label="Gastos" [sidebarExpanded]="sidebarExpanded()">
                <svg
                  slot="icon"
                  class="w-5 h-5"
                  viewBox="0 0 20 20"
                ...
                >
                  <path
                    fill-rule="evenodd"
                    d="M1.22 5.22a.75.75 0 011.06 0L8 10.94l3.72-3.72a.75.75 0 011.06 0l5.47 5.47V9.75a.75.75 0 011.5 0v5.5a.75.75 0 01-.75.75h-5.5a.75.75 0 010-1.5h3.69l-4.94-4.94-3.72 3.72a.75.75 0 01-1.06 0L1.22 6.28a.75.75 0 010-1.06z"
                    clip-rule="evenodd"
                  />
                </svg>
              </afi-nav-item>
              ...
              >
                ...
                >
                  <path
                    d="M3 3a1 1 0 000 2h1v10a2 2 0 002 2h8a2 2 0 002-2V5h1a1 1 0 100-2H3zm4 4a1 1 0 012 0v6a1 1 0 11-2 0V7zm4 2a1 1 0 012 0v4a1 1 0 11-2 0V9z"
                  />
                </svg>
              </afi-nav-item>

              <afi-nav-item label="Generador de informes" [sidebarExpanded]="sidebarExpanded()">
                <svg
                  slot="icon"
                  class="w-5 h-5"
                  viewBox="0 0 20 20"
                ...
                >
                  <path
                    fill-rule="evenodd"
                    d="M4 2a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V8l-6-6H4zm7 0v4a2 2 0 002 2h4M5 10h10v1H5v-1zm0 3h7v1H5v-1z"
                    clip-rule="evenodd"
                  />
                </svg>
              </afi-nav-item>

              <div slot="bottom" class="flex items-center justify-between gap-space-2">
                <span class="text-body-sm text-neutral-500 truncate">v0.1.0</span>
                @if (sidebarExpanded()) {
                  <afi-kbd
                    [keys]="sidebarShortcut"
                    size="sm"
                    ariaLabel="Abrir y cerrar con Comando más barra invertida"
                  />
                }
              </div>
            </afi-sidebar>
            ...
            <div
              class="flex-1 flex flex-col items-center justify-center text-neutral-400 text-body-sm gap-space-2"
            >
          ...
          <div class="flex flex-col gap-space-6 w-full">
            ...
            <div>
              ...
              <p class="text-body-sm text-neutral-500 mb-space-3">
                Sidebar + PageHeader + main + rail opcional. Grid de tres columnas.
              </p>
              <div
                class="h-[200px] w-full border border-border-hairline rounded-md overflow-hidden"
              >
                <div class="grid h-full" style="grid-template-columns: 180px 1fr 140px;">
                  <div
                    class="bg-surface-quiet border-r border-border-hairline p-space-3 flex flex-col gap-space-1"
                  >
                    <span class="text-body-sm font-medium mb-space-2">Nav</span>
                    <span
                      class="text-body-sm text-neutral-500 bg-surface-muted rounded px-space-2 py-space-1"
                      >Propuestas</span
                    >
                    <span class="text-body-sm text-neutral-400 px-space-2 py-space-1">Pólizas</span>
                    <span class="text-body-sm text-neutral-400 px-space-2 py-space-1"
                      >Clientes</span
                    >
                  </div>
                  <div class="bg-surface-base flex flex-col">
                    ...
                    <div class="flex-1 p-space-3 text-body-sm text-neutral-400">
                      Contenido principal
                    </div>
                  </div>
            ...
            <div>
              ...
              <p class="text-body-sm text-neutral-500 mb-space-3">
                Columna centrada, max 400px. Logo + card sobre surface-quiet.
              </p>
              <div
                class="h-[200px] w-full border border-border-hairline rounded-md overflow-hidden bg-surface-quiet flex items-center justify-center"
              >
            ...
            <div>
              ...
              <p class="text-body-sm text-neutral-500 mb-space-3">
                Sidebar estática + main (max 780px) + TOC rail (220px).
              </p>
              <div
                class="h-[200px] w-full border border-border-hairline rounded-md overflow-hidden"
              >
        ...
        <header class="mt-space-10 mb-space-8 pb-space-6 border-b border-border-hairline">
          ...
          <p class="text-body text-neutral-600 max-w-[640px] mt-space-2">
            Gráficos SVG dibujados a mano. Color + textura juntos, nunca solo color. Cada gráfico
            incluye tabla de datos alternativa y atajos de teclado.
          </p>
        </header>
...
export class PreviewPage {
  ...
  readonly sidebarDemo = viewChild<SidebarComponent>('sidebarDemo');
  ...
  onKeydown(e: KeyboardEvent): void {
    if ((e.metaKey || e.ctrlKey) && e.key === '\\') {
      e.preventDefault();
      this.sidebarDemo()?.toggleCollapse();
    }
  }
