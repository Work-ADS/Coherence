...
export interface PropuestaTypeOption {
  type: PropuestaType;
  title: string;
  description: string;
...
export const PROPUESTA_TYPES: PropuestaTypeOption[] = [
  {
    type: 'nueva',
    title: 'Nueva',
    description: 'Crear una cartera desde cero.',
    // Sparkles icon
    iconPath:
  ...
  },
  {
    type: 'rebalanceo',
    title: 'Rebalanceo',
    description: 'Ajustar una cartera existente a sus pesos objetivo.',
    // Scale icon
    iconPath:
  ...
  },
  {
    ...
    title: 'Modificación libre',
    description: 'Editar posiciones sin ceñirte a un modelo.',
    // Pencil/edit icon
    iconPath:
  ...
  },
  {
    type: 'reembolso',
    title: 'Reembolso',
    description: 'Solicitar una retirada parcial o total.',
